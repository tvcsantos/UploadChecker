...
public class UploadCheckerApp extends SingleFrameApplication {
    ...
    public static final String USER_HOME = SystemUtilities.USER_HOME;

    public static final String USER_OS = SystemUtilities.USER_OS;

    public static final String FILE_SEPARATOR = SystemUtilities.FILE_SEPARATOR;
    
    public static final String SETTINGS_DIR = ".uploadchecker";

    public static final Runtime APP_RUNTIME = SystemUtilities.RUNTIME;

    public static final URL APP_LOCATION = SystemUtilities.getLocation(
